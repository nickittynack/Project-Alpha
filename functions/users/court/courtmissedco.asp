...
<head><LINK REL="SHORTCUT ICON" href="images/favicon.ico">
    ...
    <title> Missed Court Order </title>
	...
	//  End -->
		...
		<div class="art-post-inner art-article">
			<h2 class="art-postheader"> Not Attended Court Order </h2>
        <div class="cleared"></div>
        <div class="art-postcontent">
		
		<p><b> Please select a court order: </b></p>
				
		<FORM NAME="addcodate" METHOD=POST ACTION="courtupdatemissedco.asp" onsubmit="return validateForm()">
			...
			<% 
				...
				Dim codate, curdate, fname, lname, oname
			...
			<p><b> Please enter a new court date and time: </b></p>
