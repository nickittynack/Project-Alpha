...
<%
	...
	Else
		...
		With cdoMessage
			...
			.TextBody = "Hi " + rs("firstName") + "," + Chr(13) + Chr(13) + "The court date and time for your offence: " + rs("offencename") + " has been set." + Chr(13) + Chr(13) + "The court date is " + codate + " at " + cotime + Chr(13) + Chr(13) + "Please be at "+ rs("courtname") + " court at the given date and time " + Chr(13) + Chr(13) + "Regards, " + Chr(13) + "NSWJLPS"	
			'.Send
		End With
