...
<div class="art-post-inner art-article">
                    <h2 class="art-postheader"> View Criminal Record </h2>
						<div class="cleared"></div>
                            <div class="art-postcontent">
								...
								<div class="row">
								<span class="label">First Name:</span><span class="formw"><input type=text name="employeeID"></span>
								</div>
								...
								<div class="row">
								<span class="label">Correctional Facility:</span><span class="formw"><input type=text name="password1"></span>
								</div>
