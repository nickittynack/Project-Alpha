...
<head><LINK REL="SHORTCUT ICON" href="images/favicon.ico">
	...
	//  End -->
        ...
        <ul class="art-vmenu">
			...
			<li>
				<a href="./courtaddcodate.asp"><span class="l"></span><span class="r"></span><span class="t">Add Date/Time</span></a>
			</li>
			<li>
				<a href="./courtaddcoverdict.asp"><span class="l"></span><span class="r"></span><span class="t">Add Verdict</span></a>
			</li>
			<li>
				<a href="./courtviewco.asp"><span class="l"></span><span class="r"></span><span class="t">Search Court Order</span></a>
			</li>
		</ul>
		...
		<div class="art-post-inner art-article">
			<h2 class="art-postheader"> Add Court Order Date/Time </h2>
        <div class="cleared"></div>
		...
		<FORM NAME="addcodate" METHOD=POST ACTION="courtupdateco.asp" onsubmit="return validateForm()">
			...
			<div class="row">
			<span class="label">Time:</span><span class="formw"><input type=Text name="time"></span>
			</div>
