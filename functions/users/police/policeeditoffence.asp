...
sql="SELECT * FROM offence where id = " & Request.Cookies("policeeditoffenceid")
...
<div class="art-post-inner art-article">
								...
								<FORM NAME="addoffender" METHOD=POST ACTION="policeeditoffenceconfirm.asp" onsubmit="return validateForm()">
										
								<div class="row">
								<span class="label">Offence ID</span><span class="formw"><%= rs("id") %></span>
								<input type="hidden" id="offid" name="offid" value='<%= rs("id") %>'>
								</div>
																
								<div class="row">
								<span class="label">Offence Name</span><span class="formw"><%= rs("offenceName") %></span>
								<input type="hidden" id="offname" name="offname" value='<%= rs("offenceName") %>'>
								</div>
								...
								<div class="row">
								<span class="label">Offence Suburb</span><span class="formw"><%= rs("offencesuburb") %></span>
								<input type="hidden" id="offsuburb" name="offsuburb" value='<%= rs("offencesuburb") %>'>
								</div>
								
								<div class="row">
								<span class="label">Offence Date</span><span class="formw"><%= rs("offencedate") %></span>
								<input type="hidden" id="offdate" name="offdate" value='<%= rs("offencedate") %>'>
								</div>
								...
								<div class="row">
								<span class="label">Street Address</span><span class="formw"><input type=text name="street" value='<%= rs("offenderaddress") %>'></span>
								</div>
								
								<div class="row">
								<span class="label">Postcode</span><span class="formw"><input type="text" name="postcode" id="postcode" autocomplete="off" value='<%= rs("offenderpostcode") %>' onkeyup="showHint(this.value)"/></span>
								</div>
								...
								<div class="row">
								<span class="label">Suburb</span><span class="formw"><input type="text" disabled="disabled" name="suburbshow" id="suburbshow" value='<%= rs("offendersuburb") %>'></span>
								<input type="hidden" id="suburb" name="suburb" value='<%= rs("offendersuburb") %>'>
								</div>
								
								<!-- suburb and state have hidden fields since disabled textfields are not sent to the server -->
								
								<div class="row">
								<span class="label">State</span><span class="formw"><input type=text disabled="disabled" name="stateshow" id="stateshow" value='<%= rs("offenderstate") %>'></span>
								<input type="hidden" id="state" name="state" value='<%= rs("offenderstate") %>'>
								</div>
								...
								<div class="row">
								<span class="label">Phone</span><span class="formw"><input type=text name="phone" value='<%= rs("offenderphone") %>'></span>
								</div>
								
								<div class="row">
								<span class="label">Email (opt)</span><span class="formw"><input type=text name="email" value='<%= rs("offenderemail") %>'></span>
								</div>
																				
															
								<div class="row" style='padding-left:140px'>
								<INPUT TYPE=SUBMIT value="Update Offence Details">
								</div>
