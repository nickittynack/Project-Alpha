...
<head><LINK REL="SHORTCUT ICON" href="images/favicon.ico">
	...
	var xmlhttp;
		...
		offence = document.getElementById("offencetype").value
		id = document.getElementById("id").value
		
		if (last=="" && first=="" && suburb=="" && offence=="" && id=="")//licence=="" && id=="")
		{
	...
	xmlhttp.open("GET","getoffencepolice.asp?f="+first+"&l="+last+"&sb="+suburb+"&of="+offence+"&id="+id ,true);
	xmlhttp.send();
	}
	...
	{
		setCookie("policeeditoffenceid",offid)
		window.location = "policeeditoffence.asp"
	}
...
<div class="art-post-inner art-article">
						...
						<div class="row">
						<span class="label">Offence ID</span><span class="formw"><input type="text" name="id" id="id" autocomplete="off" onkeyup="showHint()"/></span>
						</div>	
								
								<div class="row">
								<span class="label">Offence Type:</span>
								<span class="formw">
								<select name="offencetype" id ="offencetype" onchange="showHint()">
						...
						checkSQL = "select offencename from OffenceType"
						...
						<div class="row">
						<span class="label">Offence Suburb</span><span class="formw"><input type="text" name="suburb" id="suburb" autocomplete="off" onkeyup="showHint()"/></span>
						</div>								
