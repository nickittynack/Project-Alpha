...
<form name="form1" method="post" action="">
  <table border="0">
    ...
    <tr>
      ...
      <td>        <select name="o_day" id="o_day">
        ...
        <select name="o_month" id="o_month">
  ...
  <table border="0">
    ...
    <tr>
      <td>&nbsp;</td>
      <td><label>
        <input type="submit" name="submit" id="submit" value="Add Offence">
      </label></td>
    </tr>
  </table>
  <p>&nbsp;</p>
