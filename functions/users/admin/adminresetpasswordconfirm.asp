	...
	If (rstContent.EOF <> true) Then ' no recs	
		...
		Else
			...
			With cdoMessage
				...
				.To = rstContent("email")
				.Subject = "NSWJLPS - Reset Password"
				.TextBody = "Hi " + rstContent("firstName") + "," + Chr(13) +	Chr(13) + "Your password has been reset. Your new password is " + randomPass +  Chr(13) + Chr(13) + "Regards, " + Chr(13) + "NSWJLPS Administration"	
				.Send
			End With
...
<div class="art-post-inner art-article">
                ...
                <div class="cleared"></div>
								...
								Else				
									Response.write"An email has been sent to " + email
								End If
								%>
								<br><br>
